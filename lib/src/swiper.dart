...
import 'package:flutter_swiper_null_safety_flutter3/src/transformer_page_view/index_controller.dart';
...
//change
  ...
  Widget _buildItem(int i, int realIndex, double animationValue) {
    ...
    Alignment alignment = widget.scrollDirection == Axis.vertical
...
class _StackViewState extends _CustomLayoutStateBase<_StackSwiper> {
  ...
  Widget _buildItem(int i, int realIndex, double animationValue) {
    ...
    Offset offset = widget.scrollDirection == Axis.vertical
        ? new Offset(f, 0.0)
        : new Offset(0.0, f);
